...
_EGCSYSTEMMSG = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EGCMsgWebAPIRegistrationRequested', index=52, number=103,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EGCMsgMemCachedGet', index=53, number=200,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EGCMsgMemCachedGetResponse', index=54, number=201,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EGCMsgMemCachedSet', index=55, number=202,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EGCMsgMemCachedDelete', index=56, number=203,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EGCMsgMasterSetDirectory', index=57, number=220,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EGCMsgMasterSetDirectoryResponse', index=58, number=221,
      options=None,
      type=None),
  ],
