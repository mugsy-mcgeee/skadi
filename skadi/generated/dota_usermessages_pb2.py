...
_CDOTAUSERMSG_PARTICLEMANAGER_UPDATEPARTICLELATENCY = _descriptor.Descriptor(
...
class CDOTAUserMsg_ParticleManager(_message.Message):
  ...
  class UpdateParticleLatency(_message.Message):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
