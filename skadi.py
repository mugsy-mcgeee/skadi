...
while True:
	...
	cmd,      cmd_pos = skadi._DecodeVarint32(cmd_meta,       0)
	cmd_tick, cmd_pos = skadi._DecodeVarint32(cmd_meta, cmd_pos)
	cmd_size, cmd_pos = skadi._DecodeVarint32(cmd_meta, cmd_pos)
